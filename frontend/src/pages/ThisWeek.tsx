...
const ThisWeek: React.FC = () => {
  ...
  <div className="boxes">
    <div className="day">Content for Sunday</div>
    <div className="day">Content for Monday</div>
    <div className="day">Content for Tuesday</div>
    <div className="day">Content for Wednesday</div>
    <div className="day">Content for Thursday</div>
    <div className="day">Content for Friday</div>
    <div className="day">Content for Saturday</div>
  </div>
</div>
      </div>
    </div>
